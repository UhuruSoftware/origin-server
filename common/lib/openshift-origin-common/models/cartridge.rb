module OpenShift
  class Cartridge < OpenShift::Model
    ...
    def name
      (self.cartridge_vendor.to_s=="redhat" || self.cartridge_vendor.to_s=="uhuru" || self.cartridge_vendor.to_s.empty?) ? (self.original_name + "-" + self.version) : (self.cartridge_vendor + "-" + self.original_name + "-" + self.version)
    end
